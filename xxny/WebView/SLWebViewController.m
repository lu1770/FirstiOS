...
//    [self loadByHTML];
    if (_webView==nil) {
        ...
        [_webView loadRequest:[NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"http://u.pmdaniu.com/X9kv"]]];
...
- (void)webView:(WKWebView *)webView didFailProvisionalNavigation:(null_unspecified WKNavigation *)navigation withError:(NSError *)error {
    NSLog(@"WKWebView page load error. %@", error.localizedDescription);
